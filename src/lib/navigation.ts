...
export const modules: ModuleDef[] = [
  {
    ...
    navItems: [
      ...
      { href: "/finance/calendar", label: "Calendar", icon: CalendarRange },
      { href: "/finance/transactions", label: "Transactions", icon: ArrowLeftRight },
      { href: "/finance/payroll", label: "Payroll", icon: ClipboardList },
      { href: "/finance/accounts", label: "Business Accounts", icon: Wallet },
      { href: "/finance/personal", label: "Personal Accounts", icon: User },
